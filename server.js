    ...
    posts: [
      {
        ...
        caption: 'Демо-ролик: интерфейс как у тиктока, но без использования модуля ws. Нажми комменты, лайк и нижнюю навигацию.',
      ...
      },
      {
        ...
        caption: 'Можно грузить фото и короткие видео прямо из студии. На бесплатном Render локальные файлы и база на диске пропадут после рестарта/деплоя.',
        mediaType: 'image',
        mediaUrl: 'data:image/svg+xml;utf8,' + encodeURIComponent(`
          <svg xmlns="http://www.w3.org/2000/svg" width="720" height="1280" viewBox="0 0 720 1280">
            ...
            <text x="72" y="340" fill="#fff" font-size="44" font-family="Arial">Render demo</text>
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    if (req.method === 'GET' && pathname === '/health') {
      send(res, 200, { ok: true, service: 'tikitok-full-no-ws', uptime: Math.round(process.uptime()), users: db.users.length, posts: db.posts.length, time: nowIso() });
      return;
    }
